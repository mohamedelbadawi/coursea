            ...
            <div class="row">
                @foreach ($courses as $course)
                    <div class="col-lg-4 col-md-6 pb-4">
                        <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="{{route('course.view',$course->id)}}">
                            <img class="img-fluid" src="{{asset('images/courses/'.$course->header_image)}}" alt="">
