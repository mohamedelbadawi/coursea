                    ...
                    <nav id="topbar">
                        ...
                        <ul class="list-unstyled menu-categories" id="topAccordion">
                            ...
                            <li class="menu single-menu">
                                ...
                                <ul class="collapse submenu list-unstyled animated fadeInUp" id="menu1"
                            ...
                            <li class="menu single-menu">
                                ...
                                <ul class="collapse submenu list-unstyled animated fadeInUp" id="menu2"
                                    data-parent="#topAccordion">
                                    <li class="sub-sub-submenu-list">
                                        <a href="#uiKit" data-toggle="collapse" aria-expanded="false"
                                            class="dropdown-toggle"> Submenu 1 <svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <li class="menu single-menu active">
                                ...
                                <ul class="collapse submenu list-unstyled animated fadeInUp" id="starter-kit"
                                    data-parent="#topAccordion">
                                    <li class="active">
