                ...
                <div class="widget-content widget-content-area">
                    <div class="d-flex justify-content-between">
                        ...
                        @if (auth()->id() == $instructor->id)
                            <a href="{{ route('instructor.profile_settings', $instructor->id) }}" class="mt-2 edit-profile">
                        ...
                        <div class="">
                            <ul class="contacts-block list-unstyled">
                                ...
                                <li class="contacts-block__item">
                                    ...
                                    </svg> {{ $instructor->phone }}
                                </li>
                                <li class="contacts-block__item">
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <a href="https://www.facebook.com/{{ $instructor->facebook }}"
                                                class="social-icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <li class="list-inline-item">
                                            ...
                                            <a href="https://www.twitter.com\{{ $instructor->twitter }}" blank
                                                class="social-icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        <li class="list-inline-item">
                                            <a href="https://www.linkedin.com/{{ $instructor->linkedin }}"
                                                class="social-icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
